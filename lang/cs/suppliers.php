...
return [
    ...
    'no_input_labels' => [
        'current_supplier_logo' => 'Současné logo',
    ],
    'actions' => [
    ...
    'messages' => [
        ...
        'limit_exceeded' => 'Dosáhli jste limitu počtu dodavatelů pro tento měsíc. Důvod: :reason, Limit: :limit',
    ],
    'validation' => [
        ...
        'supplier_logo_file' => 'Logo dodavatele musí být platný soubor',
        'supplier_logo_format' => 'Logo dodavatele musí být obrázek (jpeg, jpg, png, gif, svg)',
        'supplier_logo_size' => 'Logo dodavatele nesmí být větší než :max kB',
    ],
    'hints' => [
        'supplier' => '',
        'supplier_logo' => '',
