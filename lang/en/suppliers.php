...
return [
    ...
    'titles' => [
        ...
        'supplier' => 'supplier',
        'empty' => 'You don\'t have any suppliers yet',
        'empty_message' => 'Start by creating your first supplier.',
    ],
    'sections' => [
    ...
    'messages' => [
        ...
        'set_default' => 'Supplier was successfully set as default.',
        ...
        'error_edit' => 'An error occurred while editing the supplier.',
    ...
    'validation' => [
        ...
        'account_number_format' => 'Account number must not exceed 50 characters',
