...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addAresLookupButton(icoField) {
        ...
        wrapperDiv.className = 'grid grid-cols-10 gap-2 md:col-span-2';
        ...
        let buttonClasses = 'inline-flex justify-center py-3 px-3 text-md font-semibold rounded-sm text-white hover:text-white border-1-[#490BF4] bg-[#490BF4] hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer transition-colors duration-200';
