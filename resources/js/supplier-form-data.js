...
const SupplierFormData = (function() {
    ...
    function init(options = {}) {
        ...
        if (urlSupplierId) {
            ...
            loadSupplierById(urlSupplierId, urlLocale);
        } else if (!isEditMode) {
     ...
     */
    function loadSupplierById(supplierId, locale) {
        console.log(`Loading supplier data for ID: ${supplierId} with locale: ${locale}`);
        ...
        fetch(`${baseURL}/api/supplier/${supplierId}`)
            ...
            .then(data => {
                ...
                if (data && data.id) {
                    ...
                    updateEditSupplierLink(data.id, locale);
                } else {
     ...
     * @param {string} locale - Locale to use for the request
     */
    function updateEditSupplierLink(supplierId, locale = 'cs') {
        ...
        if (supplierId) {
            ...
            const editUrl = `${baseURL}/${locale}/supplier/${supplierId}/edit`;
