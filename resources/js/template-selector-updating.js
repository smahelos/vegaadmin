...
class TemplateSelectorUpdating {
    constructor() {
    ...
    confirmSelection() {
        ...
        if (!this.hiddenInput) {
            this.hiddenInput = document.querySelector('#template-selection-form input[name="template"]');
        }
    ...
    submitForm() {
        ...
        if (form) {
            ...
            console.error('Template selection form not found');
        }
    }
    ...
    loadCurrentTemplate() {
        ...
        this.currentHiddenInput = document.querySelector('input[name="current_template"]');
        this.hiddenInput = document.querySelector('#template-selection-form input[name="template"]');
        
        if (this.currentHiddenInput && this.currentHiddenInput.value) {
            this.currentTemplate = this.currentHiddenInput.value;
            if (this.hiddenInput) {
                this.hiddenInput.value = this.currentHiddenInput.value;
            }
        }
...
document.addEventListener('DOMContentLoaded', () => {
    window.templateSelectorUpdating = new TemplateSelectorUpdating();
});
