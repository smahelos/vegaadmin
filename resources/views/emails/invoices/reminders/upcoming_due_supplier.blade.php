...
@section('content')
    ...
    <p class="paragraph">
        {{ __('invoices.reminders.upcoming_due_intro_supplier', ['number' => $invoice->invoice_vs, 'client' => $invoice->client_name, 'days' => $daysLeft]) }}
    </p>

    <p class="paragraph">
        {{ __('invoices.reminders.due_date_info', ['date' => $dueDate]) }}
    </p>
