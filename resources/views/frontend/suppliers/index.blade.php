...
<div class="flex justify-between items-center mb-6">
    <h1 class="main_title text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4 leading-tight pt-3">{{ __('suppliers.titles.index') }}</h1>
...
@auth
<div class="mb-6">
    <x-uels-limit-widget entity-type="supplier" limit="{{ $limitsData['limit'] }}" entity-name="{{ __('uels.entities.supplier') }}" :show-modal="true" />
</div>
@endauth
