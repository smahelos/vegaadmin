...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl text-amber-600">{{ __('invoices.titles.invoice_number', ['number' => $invoice->invoice_vs]) }}
    </h1>
    <div class="flex space-x-4">
        ...
        <form method="POST"
            ...
            @method('PUT')
            <button type="submit"
                class="px-4 py-2 bg-emerald-200 hover:bg-emerald-500 rounded-md text-gray-700 hover:text-white text-sm font-medium transition-colors">
        ...
        <a href="{{ route('frontend.invoice.edit', ['locale' => app()->getLocale(), 'id' => $invoice->id]) }}"
            class="px-4 py-2 bg-green-200 hover:bg-emerald-500 rounded-md text-gray-700 hover:text-white text-sm font-medium transition-colors">
            <i class="fas fa-pencil-alt"></i> {{ __('invoices.actions.edit') }}
        </a>
        <button id="previewPdfBtn" type="button"
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex border-b border-gray-100 pb-3">
                        <div class="w-1/3 text-sm font-medium text-gray-600">{{ __('invoices.fields.invoice_vs_long') }}
                        </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2 mb-4">
                            <div class="border-l-4 border-green-500 pl-3 py-1">
                                ...
                                <div class="font-medium">{{ number_format($invoice->payment_amount, 2, ',', ' ') }} {{
                                    $invoice->payment_currency }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full md:w-1/2 mb-4">
                                <div class="border-l-4 border-red-500 pl-3 py-1">
                                    ...
                                    <div class="font-medium">{{ $invoice->client->zip }}, {{ $invoice->client->country
                                        }}</div>
                                </div>
                            </div>
                            <div class="w-full md:w-1/2 mb-4">
                ...
                <div class="space-y-4">
                    <div class="mt-4 space-y-4">
                        <div class="">
                            ...
                            <!-- Invoice items -->
                            <h3 class="text-base font-medium text-gray-900 mb-4 ml-4">{{
                            ...
                            <!-- Invoice note -->
                            <h3 class="text-base font-medium text-gray-900 mb-2 mt-6 ml-4">{{
