                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div id="image-preview-container">
                                            @if ($product->image)
                                                <img id="current-image-preview" src="{{ Storage::disk('public')->url($product->image) }}" alt="{{ $product->name }}"
                                                    class="max-h-40 object-cover rounded-md">
                                                <p id="no-image-message" class="text-gray-500 hidden">{{ __('products.messages.no_image') }}</p>
                                            @else
                                                <p id="no-image-message" class="text-gray-500">{{ __('products.messages.no_image') }}</p>
                                                <img id="current-image-preview" src="" alt="{{ $product->name }}" class="max-h-40 object-cover rounded-md hidden">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    <label for="is_default" class="flex items-center">
                                        ...
                                        <input type="checkbox" name="is_default" id="is_default" value="1"
                                            {{ old('is_default', $product->is_default) ? 'checked' : '' }}
