...
<form action="{{ route('frontend.product.store', ['locale' => app()->getLocale()]) }}" method="POST"
                            ...
                            <div class="md:col-span-1 @if(!$errors->has('image'))mb-5 @endif">
                                <label for="image"
                                    ...
                                    <div class="flex flex-col items-center justify-center p-3">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 wrap-break-word">
                            ...
                            <div class="md:col-span-1 @if(!$errors->has('image'))mb-5 @endif">
                                <div id="image-preview-container">
                                    <img id="current-image-preview"
                                        ...
                                        class="max-h-37 object-cover rounded-sm m-auto">
                                </div>
                            </div>
                            @error('image')
