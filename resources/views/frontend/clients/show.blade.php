...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-4">
        <a href="@localizedRoute('frontend.clients')" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700 text-sm font-medium transition-colors">
            <i class="fas fa-arrow-left mr-2"></i> {{ __('clients.actions.back_to_list') }}
        </a>
        <a href="@localizedRoute('frontend.client.edit', $client->id)" class="px-4 py-2 bg-green-200 hover:bg-emerald-500 rounded-md text-sm text-gray-700 hover:text-white font-medium transition-colors">
...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="@localizedRoute('frontend.invoice.create', ['client_id' => $client->id])" class="px-4 py-2 bg-blue-300 hover:bg-cyan-600 rounded-md text-gray-700 hover:text-white text-sm font-medium transition-colors">
