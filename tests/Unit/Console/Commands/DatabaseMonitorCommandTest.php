...
use App\Console\Commands\DatabaseMonitorCommand;
...
{
    private DatabaseMonitorCommand $command;

    protected function setUp(): void
    {
        parent::setUp();
        $this->command = new DatabaseMonitorCommand();
    }
    ...
    public function command_has_correct_signature(): void
    {
        ...
        $this->assertStringContainsString('db:monitor', $signature);
    }
    ...
    public function command_has_correct_description(): void
    {
        ...
        $this->assertStringContainsString('Monitor', $description);
    }
