...
class HasFileUploadsTest extends TestCase
{
    ...
    {
        $this->assertTrue(trait_exists('App\\Infrastructure\\Shared\\File\\Traits\\HasFileUploads'));
    }

    #[Test]
    public function trait_has_required_methods(): void
    {
        $reflection = new \ReflectionClass('App\\Infrastructure\\Shared\\File\\Traits\\HasFileUploads');
    ...
    {
        $reflection = new \ReflectionClass('App\\Infrastructure\\Shared\\File\\Traits\\HasFileUploads');
        $this->assertEquals('App\\Infrastructure\\Shared\\File\\Traits', $reflection->getNamespaceName());
    }
