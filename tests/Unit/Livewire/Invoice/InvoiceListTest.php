...
namespace Tests\Unit\Livewire\Invoice;
...
class InvoiceListTest extends TestCase
{
    ...
    {
        $reflection = new ReflectionClass($this->component);
        $this->assertEquals('App\Livewire\Invoice', $reflection->getNamespaceName());
    }

    #[Test]
    public function component_uses_required_imports(): void
    {
    $fileContent = file_get_contents(app_path('Livewire/Invoice/InvoiceList.php'));
