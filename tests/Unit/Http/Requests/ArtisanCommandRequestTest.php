...
/**
 * Unit tests for ArtisanCommandRequest - CRITICAL RULE: Only pure business logic, no Laravel dependencies
 * 
 ...
 */
class ArtisanCommandRequestTest extends TestCase
{
    private ArtisanCommandRequest $request;

    protected function setUp(): void
    {
        parent::setUp();
        $this->request = new ArtisanCommandRequest();
    }
