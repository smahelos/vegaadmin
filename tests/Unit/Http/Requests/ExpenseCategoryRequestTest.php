...
/**
 * Unit tests for ExpenseCategoryRequest - CRITICAL RULE: Only pure business logic, no Laravel dependencies
 * 
 ...
 */
class ExpenseCategoryRequestTest extends TestCase
{
    private ExpenseCategoryRequest $request;

    protected function setUp(): void
    {
        parent::setUp();
        $this->request = new ExpenseCategoryRequest();
    }
    ...
    #[Test]
    public function prepare_for_validation_method_exists_and_is_protected(): void
    {
        $reflection = new \ReflectionClass($this->request);
