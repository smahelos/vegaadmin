...
/**
 * Unit tests for Admin\ProductCategoryRequest - CRITICAL RULE: Only pure business logic, no Laravel dependencies
 * 
...
class ProductCategoryRequestTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->request = new ProductCategoryRequest();
    }
    ...
    public function has_required_methods(): void
    {
        ...
        foreach ($requiredMethods as $method) {
            $this->assertTrue(
                ...
                "Method {$method} does not exist in Admin\ProductCategoryRequest class"
            );
        }
    }
