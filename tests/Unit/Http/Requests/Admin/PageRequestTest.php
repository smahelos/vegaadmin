...
/**
 * Unit test for Admin PageRequest class.
...
class PageRequestTest extends TestCase
{
    ...
    public function rules_contains_required_validation_rules(): void
    {
        ...
        $this->assertTrue(method_exists(PageRequest::class, 'rules'));
        
        $reflection = new \ReflectionClass(PageRequest::class);
        $method = $reflection->getMethod('rules');
        $this->assertTrue($method->isPublic());
    ...
    public function attributes_contains_expected_field_names(): void
    {
        ...
        $this->assertTrue(method_exists(PageRequest::class, 'attributes'));
    ...
    public function messages_contains_expected_validation_messages(): void
    {
        ...
        $this->assertTrue(method_exists(PageRequest::class, 'messages'));
