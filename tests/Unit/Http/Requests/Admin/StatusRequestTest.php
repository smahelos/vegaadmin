...
/**
 * Unit tests for Admin\StatusRequest - CRITICAL RULE: Only pure business logic, no Laravel dependencies
 * 
    ...
    public function has_required_methods(): void
    {
        ...
        foreach ($requiredMethods as $method) {
            $this->assertTrue(
                ...
                "Method {$method} does not exist in Admin\StatusRequest class"
            );
        }
    }
