...
/**
 * Unit tests for Admin\UserRequest - CRITICAL RULE: Only pure business logic, no Laravel dependencies
 * 
...
class UserRequestTest extends TestCase
{
    ...
    public function has_required_methods(): void
    {
        ...
        foreach ($requiredMethods as $method) {
            $this->assertTrue(
                ...
                "Method {$method} does not exist in Admin\UserRequest class"
            );
        }
    }
    ...
    {
        $reflection = new \ReflectionClass($this->request);
        $methods = ['authorize', 'rules', 'attributes', 'messages', 'isCreateOperation'];
