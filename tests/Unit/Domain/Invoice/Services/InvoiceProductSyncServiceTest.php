...
class InvoiceProductSyncServiceTest extends TestCase
{
    ...
    // Two service methods + constructor
    $this->assertCount(3, $serviceMethods);
    }
    ...
    public function method_parameter_types_are_correct(): void
    {
        ...
        $this->assertEquals('invoiceId', $parameters[0]->getName());
        $this->assertEquals('App\Domain\Invoice\ValueObjects\InvoiceId', $parameters[0]->getType()->getName());
