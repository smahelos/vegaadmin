...
class InvoiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'street' => ['required', 'string', 'max:255', 'required_without:supplier_id'],
            'city' => ['required', 'string', 'max:255', 'required_without:supplier_id'],
            'zip' => ['required', 'string', 'max:20', 'required_without:supplier_id'],
            'country' => ['required', 'string', 'max:255', 'required_without:supplier_id'],
            ...
            'client_street' => ['required', 'string', 'max:255', 'required_without:client_id'],
            'client_city' => ['required', 'string', 'max:255', 'required_without:client_id'],
            'client_zip' => ['required', 'string', 'max:20', 'required_without:client_id'],
            'client_country' => ['required', 'string', 'max:255', 'required_without:client_id'],
